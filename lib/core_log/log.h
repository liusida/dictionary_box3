...
#define ESP_LOGDx(tag, format, ...) ESP_LOGD(tag, LOG_COLOR_GREEN format LOG_COLOR_RESET, ##__VA_ARGS__)
#define ESP_LOGIx(tag, format, ...) ESP_LOGI(tag, LOG_COLOR_GREEN format LOG_COLOR_RESET, ##__VA_ARGS__)
#define ESP_LOGWx(tag, format, ...) ESP_LOGW(tag, LOG_COLOR_GREEN format LOG_COLOR_RESET, ##__VA_ARGS__)
#define ESP_LOGEx(tag, format, ...) ESP_LOGE(tag, LOG_COLOR_GREEN format LOG_COLOR_RESET, ##__VA_ARGS__)
#endif