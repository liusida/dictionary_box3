...
DisplayManager::DisplayManager() 
    : displayInitialized_(false), touchInitialized_(false), lvglInitialized_(false),
      display_(nullptr), inputDevice_(nullptr), buffer1_(nullptr), buffer2_(nullptr) {
}
...
void DisplayManager::initLVGL() {
    ...
    lv_display_set_buffers(display_, buffer1_, buffer2_, 320 * BUF_ROWS * sizeof(lv_color_t),
