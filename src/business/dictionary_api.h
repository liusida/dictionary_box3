...
/**
 * @brief API client for dictionary operations and audio playback
 * 
...
class DictionaryApi {
public:
    DictionaryApi(AudioManager& audioDriver);
    ~DictionaryApi();
    ...
    /**
     * @brief Check if the API client is ready (WiFi connected)
